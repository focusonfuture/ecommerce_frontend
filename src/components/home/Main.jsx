                ...
                <div className="swiper-container slider__active">
                    <div className="slider-wrapper swiper-wrapper">
                        <div
                            ...
                            data-background="assets/img/slider/01-slide-1.jpg"
                        >
                                    ...
                                    <div className="col-xl-5">
                                        <div className="slider-content">
                                            <div
                                                ...
                                                data-delay="1.5s"
                                            >
                                                <a href="product-details.html" className="st-btn b-radius">
                                                    HOT DEALS
                                                </a>
                                            </div>
                                            <h2
                                            ...
                                            >
                                                SALE 30% OFF <br /> FUTURE FOOTBALL BOOTS
                                            </h2>
                                            <p
                        ...
                        <div
                            className="single-slider swiper-slide slider-height d-flex align-items-center"
                            data-background="assets/img/slider/01-slide-2.jpg"
                        >
                            <div className="container">
                                <div className="row">
                                    <div className="col-xl-5">
                        ...
                        <div
                            className="single-slider swiper-slide slider-height d-flex align-items-center"
                            data-background="assets/img/slider/01-slide-3.jpg"
                        >
                            <div className="container">
                                <div className="row">
                                    <div className="col-xl-5">
                ...
                <div className="container">
                            ...
                            <div className="section__head d-flex justify-content-between mb-10">
                                ...
                                <div className="offer-time">
                                    ...
                                    <div className="countdown">
                                        <div
                                            className="countdown-inner b-radius"
                                            data-countdown=""
                                            data-date="Mar 02 2022 20:20:22"
                                        >
                                            <ul className="text-center">
                                                <li>
                                                    <span data-days="">36</span> Days
                                                </li>
                                                <li>
                                                    <span data-hours="">8</span> Hours
                                                </li>
                                                <li>
                                                    <span data-minutes="">16</span> Mins
                                                </li>
                                                <li>
                                                    <span data-seconds="">54</span> Secs
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                    ...
                    <div className="row">
                        <div className="product-bs-slider">
                            ...
                            <div className="bs-button bs-button-prev">
                                <i className="fal fa-chevron-left" />
                            </div>
                            <div className="bs-button bs-button-next">
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12">
                            <div className="banner__item p-relative w-img mb-30">
                                ...
                                <div className="banner__content">
                                    ...
                                    <h6>
                                        <a href="product-details.html">PC &amp; Docking Station</a>
                                    </h6>
                        ...
                        <div className="col-xl-6 col-lg-6 col-md-12">
                            <div className="banner__item p-relative mb-30 w-img">
                                ...
                                <div className="banner__content">
                                    ...
                                    <h6>
                                        <a href="product-details.html">Accessories iPhone</a>
                                    </h6>
                                                ...
                                                <div className="product__item swiper-slide">
                                                    <div className="product__thumb fix">
                                                        <div className="product-image w-img">
                                                            <a href="product-details.html">
                                                                <img
                                                                    src="assets/img/product/tp-1.jpg"
                                                                    alt="product"
                                                                />
                                                            </a>
                                                        </div>
                                                ...
                                                <div className="product__item swiper-slide">
                                                    <div className="product__thumb fix">
                                                        <div className="product-image w-img">
                                                            <a href="product-details.html">
                                                                <img
                                                                    src="assets/img/product/tp-3.jpg"
                                                                    alt="product"
                                                                />
                                                            </a>
                                                        </div>
                                                ...
                                                <div className="product__item swiper-slide">
                                                    <div className="product__thumb fix">
                                                        <div className="product-image w-img">
                                                            <a href="product-details.html">
                                                                <img
                                                                    src="assets/img/product/tp-4.jpg"
                                                                    alt="product"
                                                                />
                                                            </a>
                                                        </div>
                                                ...
                                                <div className="product__item swiper-slide">
                                                    <div className="product__thumb fix">
                                                        <div className="product-image w-img">
                                                            <a href="product-details.html">
                                                                <img
                                                                    src="assets/img/product/tp-5.jpg"
                                                                    alt="product"
                                                                />
                                                            </a>
                                                        </div>
                                                ...
                                                <div className="product__item swiper-slide">
                                                    <div className="product__thumb fix">
                                                        <div className="product-image w-img">
                                                            <a href="product-details.html">
                                                                <img
                                                                    src="assets/img/product/tp-6.jpg"
                                                                    alt="product"
                                                                />
                                                            </a>
                                                        </div>
                                        ...
                                        <div className="product__content product__content-d">
                                            ...
                                            <div className="features-des mb-25">
                                                <ul>
                                                    <li>
                                                        <a href="product-details.html">
                                                            <i className="fas fa-circle" /> Bass and Stereo Sound.
                                                        </a>
                                                    </li>
                                                    <li>
                                                        <a href="product-details.html">
                                                            <i className="fas fa-circle" /> Display with 3088 x
                                                    ...
                                                    <li>
                                                        <a href="product-details.html">
                                                            <i className="fas fa-circle" /> Androi v10.0 Operating
                                                            system.
                                                        </a>
                                                    </li>
                                                </ul>
                                            ...
                                            <div className="cart-option">
                                                <a href="cart.html" className="cart-btn-2 w-100 mr-10">
                                                    Add to Cart
                                                </a>
                                                <a href="cart.html" className="transperant-btn">
                                                    <i className="fal fa-heart" />
                                                </a>
                                            </div>
                                        </div>
                                            ...
                                            <div className="col-6">
                                                <div className="features-thum">
                                                    <div className="features-product-image w-img">
                                                        <a href="product-details.html">
                                                            <img
                                                                src="assets/img/features-product/fp-4.jpg"
                                                                alt=""
                                                            />
                                                        </a>
                                                    </div>
                            ...
                            <div className="banner__item p-relative w-img mb-30">
                                ...
                                <div className="banner__content banner__content-sd text-center">
                                    <div className="banner-button mb-20">
                                        <a href="product-details.html" className="st-btn">
                                            HOT DEALS
                                        </a>
                                    </div>
                                    <h6>
                                        <a href="product-details.html">
                                            Sale 30% Off <br /> Top Computer Case Gaming
                                        </a>
                                    </h6>
                                </div>
                            </div>
                            ...
                            <div className="row">
                                <div className="col-md-12">
                                    <div className="banner__item p-relative mb-30 w-img">
                                        ...
                                        <div className="banner__content banner__content-sd text-center">
                                            <h6>
                                                <a href="product-details.html">Electronic Deals</a>
                                            </h6>
                                ...
                                <div className="col-md-12">
                                    <div className="banner__item p-relative w-img mb-30">
                                        ...
                                        <div className="banner__content">
                                            <h6>
                                                <a href="product-details.html">
                                                    Hot Products <br /> Laptop Ultra 4K 16”
                                                </a>
                                            </h6>
                                            <p>Discount 20% On Products</p>
                                        </div>
                        ...
                        <div className="col-xl-4 col-lg-6 col-md-12">
                            <div className="banner__item p-relative mb-30 w-img">
                                ...
                                <div className="banner__content banner__content-sd text-center">
                                    ...
                                    <h6>
                                        <a href="product-details.html">
                                            Sport Edition <br /> Best Choice of The Year
                                        </a>
                                    </h6>
                                </div>
                            </div>
