...
const Footer = () => {
    return (
        <footer>
            <div className="footer-area d-dark-bg">
                                        ...
                                        <div className="footer__widget">
                                            ...
                                            <div className="footer__widget-content">
                                                <div className="footer__link">
                                                    <ul>
                                                        <li>
                                                            <a href="faq.html">New Customers</a>
                                                        </li>
                                                        <li>
                                                            <a href="faq.html">How to use Account</a>
                                                        </li>
                                                        <li>
                                                            <a href="faq.html">Placing an Order</a>
                                                        </li>
                                                        <li>
                                                            <a href="faq.html">Payment Methods</a>
                                                        </li>
                                                        <li>
                                                            <a href="faq.html">Delivery &amp; Dispatch</a>
                                                        </li>
                                                        <li>
                                                            <a href="faq.html">Problems with Order</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                            ...
                                            <div className="footer__widget-content">
                                                <div className="footer__link">
                                                    <ul>
                                                        ...
                                                        <li>
                                                            <a href="faq.html">Report Abuse</a>
                                                        </li>
                                                        <li>
                                                            <a href="faq.html">Submit a Dispute</a>
                                                        </li>
                                                        <li>
                                                            <a href="faq.html">Policies &amp; Rules</a>
                                                        </li>
                                                    </ul>
                                                </div>
                                            </div>
                                                    ...
                                                    <div className="footer__widget">
                                                        ...
                                                        <div className="footer__widget-content">
                                                            <div className="footer__link">
                                                                <ul>
                                                                    <li>
                                                                        <a href="faq.html">Product Support</a>
                                                                    </li>
                                                                    <li>
                                                                    ...
                                                                    <li>
                                                                        <a href="faq.html">Redeem Voucher</a>
                                                                    </li>
                                                                </ul>
                                                            </div>
                                                        </div>
